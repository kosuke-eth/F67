...
_PARSE_INSTR = (
    ...
    "【例】\n"
    "  売上高 営業利益 経常利益 当期純利益\n"
    "  2025年3月期 56,610 10.2 12,326 13.2 12,335 16.6 9,317 24.0\n"
    "  → 売上高=56610, 営業利益=12326, 経常利益=12335, 当期純利益=9317\n"
    "1株当たり金額（円銭）・各種比率(%)・自己資本比率は『金額』ではないので採用しない。\n"
    "【貸借対照表・財政状態】総資産・純資産 は『連結財政状態』の金額"
    "（例: 総資産 純資産 … 75,123 59,914 → 総資産=75123, 純資産=59914）。\n"
